...
export const DEFAULT_CALENDAR = {
  months: [
    ...
    { name: 'Coldmonth', days: 28 },
    { name: 'Thawmonth', days: 31 },
    { name: 'Seedmonth', days: 30 },
    { name: 'Bloommonth', days: 31 },
    { name: 'Sunmonth', days: 30 },
    { name: 'Highheat', days: 31 },
    { name: 'Harvestmonth', days: 31 },
    { name: 'Fallmonth', days: 30 },
    { name: 'Dimmonth', days: 31 },
    { name: 'Frostmonth', days: 30 },
    { name: 'Darkmonth', days: 31 },
  ],
  daysPerWeek: 7,
